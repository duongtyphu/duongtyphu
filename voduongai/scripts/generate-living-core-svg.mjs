...
${dust
  ...
  const orbit1 =
    detail.orbitCount >= 1
      ? `<ellipse class="living-core__orbit living-core__orbit--1" cx="50" cy="51" rx="53" ry="16" stroke="rgba(255,255,255,0.85)" stroke-width="0.9" />`
      : "";
  const orbit2 =
    detail.orbitCount >= 2
      ? `<ellipse class="living-core__orbit living-core__orbit--2" cx="50" cy="51" rx="49" ry="14" stroke="rgba(224,244,255,0.75)" stroke-width="0.8" />`
      : "";
  ...
  <g transform="rotate(-14 50 51)">
    ${auraEl}
    <ellipse class="living-core__body" cx="50" cy="51" rx="37" ry="35" fill="url(#${bodyGradId})" />
    ${dustEls}
    ${orbit1}
    ${orbit2}
