...
${dust
  ...
  const orbit1 =
    detail.orbitCount >= 1
      ? `<ellipse class="living-core__orbit living-core__orbit--1" cx="50" cy="51" rx="52" ry="43" stroke="rgba(255,255,255,0.95)" stroke-width="1.3" />`
      : "";
  const orbit2 =
    detail.orbitCount >= 2
      ? `<ellipse class="living-core__orbit living-core__orbit--2" cx="50" cy="51" rx="47" ry="39" stroke="#38D5FF" stroke-opacity="0.9" stroke-width="1.1" />`
      : "";
  const orbit3 =
    detail.orbitCount >= 3
      ? `<ellipse class="living-core__orbit living-core__orbit--3" cx="50" cy="51" rx="57" ry="47" stroke="#8B7DFF" stroke-opacity="0.8" stroke-width="0.9" />`
      : "";
  ...
  <defs>
    <radialGradient id="${bodyGradId}" cx="47%" cy="46%" r="68%">
      ...
      <stop offset="28%" stop-color="#38D5FF" stop-opacity="1" />
      <stop offset="48%" stop-color="#4F7DFF" stop-opacity="1" />
      <stop offset="70%" stop-color="#3B5BFF" stop-opacity="0.95" />
      <stop offset="90%" stop-color="#2F4CE0" stop-opacity="0.9" />
      <stop offset="100%" stop-color="#2F4CE0" stop-opacity="0" />
    </radialGradient>
    <radialGradient id="${auraGradId}" cx="47%" cy="46%" r="62%">
      <stop offset="0%" stop-color="rgba(180,220,255,0.65)" />
      <stop offset="55%" stop-color="rgba(120,190,255,0.34)" />
  ...
  <g>
    ...
    ${orbit2}
    ${orbit3}
    <circle class="living-core__core-glow" cx="48" cy="49" r="18" fill="url(#${coreGradId})" />
    <circle class="living-core__core" cx="48" cy="49" r="7.5" fill="#FFFFFF" />
  </g>
</svg>
`;
}
