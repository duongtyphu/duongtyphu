  ...
  return (
    <section className="bg-[#F7F8FC] pb-24">
      <div className="mx-auto max-w-[1280px] space-y-6 px-6">
        <div className="rounded-xl border border-[#ECEDF5] bg-white p-8 shadow-[0_4px_24px_rgba(15,23,60,.06)] md:flex md:items-center md:justify-between md:gap-10 md:p-11">
          <div>
            <h2 className="text-[1.5rem] font-extrabold leading-[1.3] text-[#0B0F2E] md:text-[1.65rem]">
              Lộ trình học tập dành cho mọi người
            </h2>
            <p className="mt-3.5 max-w-[560px] text-[.92rem] leading-[1.7] text-[#5B6B85]">
          ...
          <Link
            href="/login"
            className="mt-[22px] inline-flex shrink-0 items-center gap-2 rounded-xl border-[1.5px] border-[#DADCF0] bg-white px-6 py-3.5 text-[.95rem] font-bold text-[#0B0F2E] transition-colors hover:border-[#7C5CFC] hover:text-[#5b21c9] md:mt-0"
          >
            Xem tất cả lộ trình
        ...
        <div className="rounded-xl border border-[#ECEDF5] bg-white p-8 shadow-[0_4px_24px_rgba(15,23,60,.06)] md:p-11">
              ...
              <div key={s.title} className="relative z-[1] px-1.5 text-center">
                ...
                <div className="mx-auto mb-2.5 flex h-14 w-14 items-center justify-center">
                  <Image
                    ...
                    width={400}
                    height={400}
                    className="h-full w-full object-contain drop-shadow-[0_6px_12px_rgba(15,23,60,.18)]"
                  />
                </div>
