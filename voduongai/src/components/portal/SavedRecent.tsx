  ...
  return (
    <section>
      <div className="flex items-end justify-between">
        <h2 className="text-lg font-bold text-gray-900">Tài nguyên đã lưu gần đây</h2>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        {items.slice(0, 3).map((it) => (
          <Link
            key={it.id}
            href={it.href}
            className="card-shine rounded-[20px] border border-gray-200 bg-white/[0.04] p-4 transition hover:shadow-lg hover:shadow-black/30"
          >
