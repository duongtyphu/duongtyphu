...
export function LegacyHero() {
  return (
    <GemCard variant="featured" className="!p-7 sm:!p-8">
      <p className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600">My Legacy</p>
      <h1 className="mt-2 text-2xl font-extrabold text-gray-900 sm:text-3xl">Di sản số của riêng bạn.</h1>
