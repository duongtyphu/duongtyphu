...
/**
 * Nhóm 3 — Live-edit Nhật ký học tập. Y hệt
 * `mirror/EditableRegion.tsx`/`gem-home/EditableRegion.tsx` (pattern
 * pilot), chỉ đổi import `useEditMode` sang bản riêng của journal.
 */
