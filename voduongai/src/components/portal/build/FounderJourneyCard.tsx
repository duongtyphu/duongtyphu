...
export function FounderJourneyCard({ journey }: { journey: FounderJourney }) {
  return (
    <GemCard className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-5">
      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#22D3EE]/15 text-blue-600">
        <Compass className="h-5 w-5" />
      </span>
      <div className="flex-1">
        <h2 className="text-sm font-bold text-gray-900">{journey.title}</h2>
