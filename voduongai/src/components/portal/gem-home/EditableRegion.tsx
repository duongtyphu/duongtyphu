...
/**
 * Nhóm 3 — Live-edit Trang chủ Học viện. Y hệt
 * `src/components/portal/su-menh-companion/EditableRegion.tsx` (pilot),
 * chỉ đổi import `useEditMode` sang bản riêng của gem-home. Ngoài edit
 * mode (Portal thật), render `<>{children}</>` — zero rủi ro layout,
 * không lộ UI admin.
 */
