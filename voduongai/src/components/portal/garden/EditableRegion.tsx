...
/**
 * Nhóm 3 — Live-edit Khu vườn của bạn. Y hệt
 * `mirror/EditableRegion.tsx`/`journal/EditableRegion.tsx`/
 * `story/EditableRegion.tsx`/`journey-map/EditableRegion.tsx` (pattern
 * pilot), chỉ đổi import `useEditMode` sang bản riêng của garden.
 */
