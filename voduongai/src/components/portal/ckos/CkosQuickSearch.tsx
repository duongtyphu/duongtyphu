...
// search endpoint (/api/v1/ckos/search, cross-table fan-out over
// ckos_goals/ckos_prompt_templates/ckos_workflows/ckos_best_practices/
// case_studies/tools) — this IS the real Search Runtime today, at its
// current foundation-level maturity (in-memory merge, not indexed/ranked).
// Per requirement 4: not a fake search, and not a new Search Runtime build
// — just wiring the existing one into a visible UI for the first time.
type SearchResult = {
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <input
          ...
          placeholder="Tìm trong CKOS — Tool, Prompt, Workflow, Best Practice, Case Study..."
