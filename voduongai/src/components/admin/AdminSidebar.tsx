...
const navIcons: Record<string, LucideIcon> = {
  ...
  "/admin/media-center/library": Layers,
  "/admin/media-center/images": ImageIcon,
  "/admin/media-center/videos": Video,
  "/admin/media-center/documents": FileText,
  "/admin/media-center/audio": Music,
  "/admin/media-center/folders": Folder,
  "/admin/media-center/collections": Library,
  ...
  "/admin/projects-opportunities": Boxes,
  "/admin/projects-opportunities/ecosystems": Layers,
  "/admin/projects-opportunities/articles": FileText,
  "/admin/projects-opportunities/categories": FolderKanban,
  "/admin/premium": Crown,
