...
const navIcons: Record<string, LucideIcon> = {
  ...
  "/admin/moi-ngay-mot-y-tuong/y-tuong": Lightbulb,
  "/admin/moi-ngay-mot-y-tuong/danh-muc": FolderKanban,
  "/admin/moi-ngay-mot-y-tuong/tu-dien": Languages,
  "/admin/hocvienai/work-needs": Briefcase,
  "/admin/hocvienai/faq": HelpCircle,
  "/admin/hocvienai/slide-lessons": Presentation,
  "/admin/hocvienai/videos": Clapperboard,
  "/admin/tools": Wrench,
  ...
  "/admin/premium/v2-dashboard": Gem,
