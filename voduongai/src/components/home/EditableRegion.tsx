 ...
 * opportunities/premium/home — 10 bản sao byte-for-byte, chỉ khác import
 * `useEditMode`).
 *
 * Popover render qua `createPortal` thẳng vào `document.body` (thoát khỏi
 * mọi `overflow-hidden`/stacking context của tổ tiên), định vị theo toạ độ
 * thật của vùng trigger, `max-h-[70vh] overflow-y-auto` để tự cuộn khi
 * danh sách field dài hơn màn hình — xem lịch sử bug ở CLAUDE.md mục
 * "popup Live-edit bị cắt cụt" (Dự án & Cơ hội).
 */
