...
export function Hero() {
  return (
    <section className="relative overflow-hidden mesh-light pt-24 pb-16 text-brand-navy md:pt-28 md:pb-20">
      <div className="mx-auto grid max-w-6xl gap-14 px-5 md:grid-cols-2 md:items-center">
        ...
        >
          ...
          <p className="mt-6 max-w-lg text-base leading-relaxed text-brand-gray-700">
        ...
        >
          ...
          <div className="overflow-hidden rounded-[28px] border border-brand-gray-200 bg-white p-3 shadow-2xl shadow-brand-blue/10 backdrop-blur">
            <div className="flex items-center gap-1.5 border-b border-brand-gray-200 px-3 pb-3">
                  ...
                  (m, i) => (
                    <div
                      ...
                      className={`rounded-lg px-2.5 py-2 text-[11px] font-medium ${
                        i === 0
                          ? "bg-brand-gray-100 text-brand-navy"
                          : "text-brand-gray-500"
                      }`}
                    >
                      {m}
