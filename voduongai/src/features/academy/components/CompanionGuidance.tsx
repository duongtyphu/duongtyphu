...
/**
 * Feature 06 — Companion Guidance. Không nói "bạn còn N bài" — chỉ gợi ý
 * hành động cụ thể theo giọng đồng hành (xem docs/Academy/JourneyRules.md).
 */
export function CompanionGuidance({ message }: { message: string }) {
