      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-white/60">
            Redirect Registry — danh sách rule 301/302 (WEB-SPR-005 Foundation). Không có Redirect Engine Runtime —
            Registry chỉ lưu danh sách, chưa nối dây để thực sự chuyển hướng request thật. Toàn bộ redirect thật của
