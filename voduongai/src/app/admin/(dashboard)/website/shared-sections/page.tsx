      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-white/60">
            Danh sách Nội dung dùng chung — quản lý nội dung/copy của 9 khối dùng chung: Hero, CTA, Banner, Feature,
            Founder, Testimonial, FAQ, Footer, Announcement (WEB-SPR-004 Foundation). Quản lý headline/body/CTA —
            không có công cụ dựng Section, công cụ dựng Landing Page, công cụ AI tự sinh nội dung, hay Dynamic Layout Engine, không kéo-thả. Xem
