      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-white/60">
            Cấu hình thương hiệu tổng thể (1 record duy nhất). <strong>Lưu ý:</strong> một phần field (logo/favicon,
            tagline) chồng lấn với System Settings hiện có (/admin/settings) — đã ghi nhận, KHÔNG tự gộp 2 trang, xem
            báo cáo BRAND-SPR-001.
          </p>
        </div>
