      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-white/60">
            Metadata ảnh Open Graph mặc định của thương hiệu và Social Preview (Twitter Card) — dùng chung Brand
            Asset Registry, lọc theo category &quot;Open Graph Image&quot;. <strong>Khác</strong> với Open Graph
            title/description theo từng trang (thuộc SEO Registry của Website Workspace, xem WEB-SPR-005) — mục này
