...
export const metadata = { title: "Ebook · Admin" };
...
const fields: FieldConfig[] = [
  ...
  { key: "type", label: "Loại", type: "select", options: ["Ebook"], required: true },
...
export default function AdminCkosEbooksPage() {
  return (
    <AdminAtmosphere atmosphereClassName="ckos-atmosphere-bg">
      <DataTable<AdminResource> collectionKey="ebooks" title="Ebook" columns={columns} fields={fields} />
    </AdminAtmosphere>
  );
}
