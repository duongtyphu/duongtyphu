...
export default function CkosEvaluationsAdminPage() {
  return (
    <KnowledgeCrudPage
      title="Evaluations"
      description="Mô hình đánh giá/chấm điểm chất lượng đầu ra — nền tảng cho Evaluation Intelligence tương lai (chưa xây hệ thống đánh giá tự động trong sprint này)."
