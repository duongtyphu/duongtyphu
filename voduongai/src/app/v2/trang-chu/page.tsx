...
export default function TrangChuPortalPage() {
          ...
          <div className="content">
            <div className="center-col">
              ...
              <section>
                ...
                <div className="learn-grid">
                  <div className="learn-card" style={{ background: "linear-gradient(155deg,#f4efff 0%,#e4d9ff 100%)" }}>
                    <span className="learn-tag" style={{ background: "#ded0ff", color: "#5a37e6" }}>ĐANG HỌC</span>
                    <div className="learn-icon" style={{ width: "44px", height: "44px", borderRadius: "11px", background: "linear-gradient(145deg,#8b6bff,#5a37e6)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <h4>AI Cơ bản cho người mới bắt đầu</h4>
                    <div className="learn-progress-track"><div className="learn-progress-fill" style={{ width: "65%", background: "#7c5cfc" }} /></div>
                    <span className="learn-pct">65%</span>
                    <div className="learn-cta">Tiếp tục học</div>
                  </div>
                  <div className="learn-card" style={{ background: "linear-gradient(155deg,#eafaf0 0%,#cdf0dc 100%)" }}>
                    <span className="learn-tag" style={{ background: "#c8ecd6", color: "#16743a" }}>ĐANG HỌC</span>
                    <div className="learn-icon" style={{ width: "44px", height: "44px", borderRadius: "11px", background: "linear-gradient(145deg,#3ecf7e,#189a52)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#fff" strokeWidth="1.8">
                        <path d="M21 11.5a8.5 8.5 0 01-8.5 8.5 8.4 8.4 0 01-3.9-.94L3 21l1.5-4.5A8.4 8.4 0 013.5 12 8.5 8.5 0 0112 3.5a8.5 8.5 0 019 8z" />
                      </svg>
                    </div>
                    <h4>ChatGPT Mastery: Từ cơ bản đến nâng cao</h4>
                    <div className="learn-progress-track"><div className="learn-progress-fill" style={{ width: "38%", background: "#22b35d" }} /></div>
                    <span className="learn-pct">38%</span>
                    <div className="learn-cta">Tiếp tục học</div>
                  </div>
                  <div className="learn-card" style={{ background: "linear-gradient(155deg,#eaf2ff 0%,#cfe1ff 100%)" }}>
                    <span className="learn-tag" style={{ background: "#ded0ff", color: "#5a37e6" }}>ĐANG HỌC</span>
                    <div className="learn-icon" style={{ width: "44px", height: "44px", borderRadius: "11px", background: "linear-gradient(145deg,#8b6bff,#5a37e6)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <h4>AI trong Marketing và Content Creation</h4>
                    <div className="learn-progress-track"><div className="learn-progress-fill" style={{ width: "30%", background: "#7c5cfc" }} /></div>
                    <span className="learn-pct">30%</span>
                    <div className="learn-cta">Tiếp tục học</div>
                  </div>
                  <div className="learn-card" style={{ background: "linear-gradient(155deg,#f6f5fa 0%,#e6e4ef 100%)" }}>
                    <span className="learn-tag" style={{ background: "#e2e0ec", color: "#57506f" }}>CHƯA BẮT ĐẦU</span>
                    <div className="learn-icon" style={{ width: "44px", height: "44px", borderRadius: "11px", background: "linear-gradient(145deg,#9791b8,#5f5980)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <h4>AI Automation với No-code</h4>
                    <div className="learn-progress-track"><div className="learn-progress-fill" style={{ width: "0%", background: "#9791b8" }} /></div>
                    <span className="learn-pct">0%</span>
                    <div className="learn-cta">Bắt đầu học</div>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="sugg-grid">
                  <div className="sugg-card">
                    <span className="sugg-type" style={{ background: "#f1ebff", color: "#5a37e6" }}>PROMPT</span>
                    <div className="sugg-icon" style={{ background: "linear-gradient(145deg,#8b6bff,#5a37e6)" }}>
                    ...
                    <h5>100+ Prompt viết Content Marketing</h5>
                    <span className="sugg-meta">124 lượt tải</span>
                  </div>
                  <div className="sugg-card">
                    <span className="sugg-type" style={{ background: "#eaf1ff", color: "#1d4ed8" }}>TEMPLATE</span>
                    <div className="sugg-icon" style={{ background: "linear-gradient(145deg,#5f8fff,#1d5fd8)" }}>
                      <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M6.5 2.5h8l5 5v14h-13z" />
                        <path d="M14.5 2.5v5h5M9 13h6M9 16.5h6" />
                      </svg>
                    </div>
                    <h5>Mẫu kế hoạch Marketing AI</h5>
                    <span className="sugg-meta">89 lượt tải</span>
                  </div>
                  <div className="sugg-card">
                    <span className="sugg-type" style={{ background: "#e6f7ec", color: "#16743a" }}>WORKFLOW</span>
                    <div className="sugg-icon" style={{ background: "linear-gradient(145deg,#3ecf7e,#189a52)" }}>
                      <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M4 8h12.5l-3-3M20 16H7.5l3 3" />
                      </svg>
                    </div>
                    <h5>Quy trình nghiên cứu thị trường với AI</h5>
                    <span className="sugg-meta">156 lượt tải</span>
                  </div>
                  <div className="sugg-card">
                    <span className="sugg-type" style={{ background: "#fdeee6", color: "#b45309" }}>EBOOK</span>
                    <div className="sugg-icon" style={{ background: "linear-gradient(145deg,#ff9d52,#b45309)" }}>
                      <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <h5>Cẩm nang AI cho người mới</h5>
                    <span className="sugg-meta">312 lượt tải</span>
                  </div>
                  <div className="sugg-card">
                    <span className="sugg-type" style={{ background: "#eaf6f9", color: "#0e7490" }}>TOOL</span>
                    <div className="sugg-icon" style={{ background: "linear-gradient(145deg,#4bc4e0,#0e7490)" }}>
                      <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M14.5 6.2a3.8 3.8 0 00-5 4.8l-6 6 2.5 2.5 6-6a3.8 3.8 0 004.8-5l-2.4 2.4-2.1-.6-.6-2.1z" />
                      </svg>
                    </div>
                    <h5>Top 20 AI Tools khuyên dùng</h5>
                    <span className="sugg-meta">245 lượt xem</span>
                  </div>
                </div>
              </section>
            </div>
            ...
            <aside className="right-col">
              <div className="card greet">
                <h3>Xin chào, Võ Đương! 👋</h3>
                <span className="premium-pill">Premium Member</span>
                <div className="greet-row"><span>Gói</span><b>Premium Monthly</b></div>
                <div className="greet-row"><span>Hết hạn</span><b>01/06/2025</b></div>
                <button>Quản lý gói Premium</button>
              </div>

              <div className="card">
                <div className="card-head"><h4>Hành trình của bạn</h4><a href="#">Xem chi tiết</a></div>
                <div className="journey-top">
                  <div className="journey-badge" style={{ background: "linear-gradient(145deg,#b18bff,#6d4aff)" }}>
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="#fff">
                      <path d="M12 2l3 7h7l-5.5 4.5L18 21l-6-4-6 4 1.5-7.5L2 9h7z" />
                    </svg>
                  </div>
                  <div><div className="lvl">Cấp độ hiện tại</div><div className="lvl-name">Người học AI</div></div>
                </div>
                <div className="xp-track"><div className="xp-fill" style={{ width: "40%" }} /></div>
                <div className="xp-label">1200 / 3000 XP</div>
                <div className="stat-pair">
                  <div className="stat-box">
                    <div className="n">
                      <svg viewBox="0 0 24 24" width="17" height="17" fill="#e2331f" style={{ verticalAlign: "-3px", marginRight: "3px" }}>
                        <path d="M12.5 2.3c.5 3-1.7 4.1-2.8 6.3-.8 1.6-.7 3.1.2 4.3.2-1 .8-1.8 1.6-2.4-.1 1.2.3 2 1.1 2.6.6.5.9 1.1.9 1.8 0 1.4-1.3 2.5-3 2.5-2.2 0-4.1-1.6-4.1-4 0-2.5 1.5-3.9 2.7-5.5 1-1.3 1.8-2.7 1.7-5.6.5.3 1.4 1.1 1.7 2z" />
                        <path d="M14.8 12.4c1 .8 1.6 1.9 1.6 3.2 0 2.7-2.3 4.9-5.4 4.9-1 0-1.9-.2-2.7-.6.6.15 1.2.2 1.9.2 3 0 5.3-1.9 5.3-4.6 0-1.1-.3-2.1-.7-3.1z" opacity=".6" fill="#ff8a3d" />
                      </svg>
                      7 ngày
                    </div>
                    <div className="l">Chuỗi ngày học</div>
                  </div>
                  <div className="stat-box">
                    <div className="n">
                      <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="#6d4aff" strokeWidth="2" style={{ verticalAlign: "-2px", marginRight: "3px" }}>
                        <circle cx="12" cy="12" r="9" />
                        <path d="M12 7v5l3 3" />
                      </svg>
                      32:45
                    </div>
                    <div className="l">Tổng thời gian học</div>
                  </div>
                </div>
              </div>

              <div className="card">
                <div className="card-head"><h4>Truy cập nhanh</h4></div>
                <div className="list-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M4 19.5A2.5 2.5 0 016.5 17H20M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5z" />
                  </svg>
                  Nhật ký học tập<span className="arrow">›</span>
                </div>
                <div className="list-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <circle cx="12" cy="12" r="9" />
                  ...
                  Lộ trình của tôi<span className="arrow">›</span>
                </div>
                <div className="list-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M12 3v13m0 0l-4-4m4 4l4-4M4 21h16" />
                  </svg>
                  Tài liệu đã lưu<span className="arrow">›</span>
                </div>
                <div className="list-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M20.8 4.6a5.5 5.5 0 00-7.8 0L12 5.6l-1-1a5.5 5.5 0 10-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 000-7.8z" />
                  </svg>
                  Công cụ yêu thích<span className="arrow">›</span>
                </div>
                <div className="list-row">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <circle cx="8" cy="8" r="3" />
                  ...
                  Cộng đồng thảo luận<span className="arrow">›</span>
                </div>
              </div>

              <div className="card">
                <div className="card-head"><h4>Thông báo mới</h4><a href="#">Xem tất cả</a></div>
                <div className="notice-row">
                  <div className="notice-dot" />
                  <div>
                    <div className="t">Có tài liệu mới trong CKOS<br />Bộ Prompt SEO 2025 đã được cập nhật</div>
                    <div className="time">2 giờ trước</div>
                  </div>
                </div>
                <div className="notice-row">
                  <div className="notice-dot" style={{ background: "#22b35d" }} />
                  <div>
                    <div className="t">Khóa học AI Automation<br />Có 3 bài học mới bạn chưa mở khóa</div>
                    <div className="time">1 ngày trước</div>
                  </div>
                </div>
                <div className="notice-row">
                  <div className="notice-dot" style={{ background: "#e2b23c" }} />
                  <div>
                    <div className="t">Sự kiện Webinar<br />AI trong kinh doanh — Đăng ký ngay!</div>
