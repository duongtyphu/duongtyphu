...
const STEPS: StartHereStep[] = [
  {
    ...
    tool: { label: "ChatGPT", href: "/portal/aiworkspace#ai-toolbox" },
  },
  {
    step: 2,
    ...
    tool: { label: "Claude", href: "/portal/aiworkspace#ai-toolbox" },
  },
  {
    step: 3,
    ...
    tool: { label: "Canva", href: "/portal/aiworkspace#ai-toolbox" },
  },
  {
    step: 4,
    title: "Bắt đầu Affiliate Marketing",
    description: "Chọn ngách, chọn sản phẩm phù hợp và xây hệ thống Affiliate đầu tiên.",
    resource: { label: "Dự án & Cơ hội", href: "/portal/duan-cohoi" },
    tool: { label: "Hostinger / Vercel", href: "/portal/aiworkspace#ai-toolbox" },
  },
  {
    step: 5,
