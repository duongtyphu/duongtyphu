...
const STEPS: StartHereStep[] = [
  {
    ...
    tool: { label: "ChatGPT", href: "/portal/aiworkspace" },
  },
  {
    step: 2,
    ...
    tool: { label: "Claude", href: "/portal/aiworkspace" },
  },
  {
    step: 3,
    ...
    tool: { label: "Canva", href: "/portal/aiworkspace" },
  },
  {
    step: 4,
    ...
    tool: { label: "Hostinger / Vercel", href: "/portal/aiworkspace" },
  },
  {
    step: 5,
