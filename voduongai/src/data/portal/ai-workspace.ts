 ...
 * /portal/khong-gian-ai. Không thay thế dữ liệu AI_TOOLS/AI_ARTICLES/
...
export const LEARNING_PATHS: LearningPath[] = [
  ...
  { id: "ung-dung-cong-viec", level: 2, title: "Ứng dụng AI vào công việc", goal: "Dùng AI cho các công việc hàng ngày.", missionCount: 8, href: "/portal/academy" },
  ...
  { id: "tu-dong-hoa", level: 4, title: "Tự động hóa với AI", goal: "Kết nối công cụ, giảm việc lặp lại thủ công.", missionCount: 6, href: "/portal/khong-gian-ai/tu-dong-hoa" },
