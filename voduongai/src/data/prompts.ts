export type Prompt = {
  id: string;
  title: string;
  category: "Marketing" | "Affiliate" | "Copywriting" | "Research" | "SEO" | "Website" | "Design" | "Video" | "Business";
  preview: string;
};
...
export const prompts: Prompt[] = [
  ...
  { id: "p2", title: "Viết caption bán hàng chuyển đổi cao", category: "Copywriting", preview: "Viết 3 caption bán hàng theo công thức AIDA cho sản phẩm [X], giọng văn gần gũi..." },
  ...
  { id: "p4", title: "Nghiên cứu chân dung khách hàng", category: "Research", preview: "Xây chân dung khách hàng mục tiêu cho sản phẩm [X]: nhu cầu, nỗi đau, hành vi mua..." },
  ...
  { id: "p7", title: "Gợi ý bố cục thiết kế trang đích", category: "Design", preview: "Gợi ý bố cục (wireframe bằng văn bản) cho landing page ngách [X], ưu tiên mobile..." },
  ...
  { id: "p9", title: "Phân tích mô hình kinh doanh Affiliate", category: "Business", preview: "Phân tích mô hình kinh doanh Affiliate phù hợp với nguồn lực: 1 người, ít vốn..." },
  ...
  { id: "p12", title: "Viết tiêu đề bài viết thu hút click", category: "Copywriting", preview: "Viết 10 tiêu đề thu hút cho bài viết về [chủ đề], tối ưu CTR mà không giật tít sai..." },
];
