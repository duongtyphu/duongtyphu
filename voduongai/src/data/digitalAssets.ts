...
export const digitalAssetLinks: DigitalAssetLink[] = [
  { id: "dal_1", projectId: "da_digiu_ecosystem", title: "Website chính", type: "Website", url: "https://example.com/digiu", ctaText: "Truy cập dự án", description: "Trang thông tin chính thức của DigiU Ecosystem.", isAffiliate: false, clickCount: 340, status: "Active", order: 1 },
  { id: "dal_2", projectId: "da_digiu_ecosystem", title: "Link đăng ký", type: "Affiliate", url: "https://example.com/digiu/ref", ctaText: "Tìm hiểu thêm", description: "Link giới thiệu cá nhân nếu bạn muốn đăng ký.", isAffiliate: true, trackingCode: "ref_digiu_01", clickCount: 812, status: "Active", order: 2 },
  { id: "dal_3", projectId: "da_digiu_ecosystem", title: "Cộng đồng Telegram", type: "Telegram", url: "https://t.me/digiu_example", ctaText: "Tham gia cộng đồng", description: "Nơi cập nhật tin tức và thảo luận về DigiU.", isAffiliate: false, clickCount: 215, status: "Active", order: 3 },

  { id: "dal_4", projectId: "da_webwisepay", title: "Website chính", type: "Website", url: "https://example.com/webwisepay", ctaText: "Truy cập dự án", description: "Trang giới thiệu giải pháp thanh toán WebWisePay.", isAffiliate: false, clickCount: 128, status: "Active", order: 1 },
  { id: "dal_5", projectId: "da_webwisepay", title: "Hướng dẫn sử dụng", type: "Guide", url: "https://example.com/webwisepay/guide", ctaText: "Xem hướng dẫn", description: "Hướng dẫn bắt đầu sử dụng WebWisePay.", isAffiliate: false, clickCount: 96, status: "Active", order: 2 },

  { id: "dal_6", projectId: "da_ai_hub", title: "Website chính", type: "Website", url: "https://example.com/ai-hub", ctaText: "Truy cập dự án", description: "Trang giới thiệu AI Hub trong hệ sinh thái DigiU.", isAffiliate: false, clickCount: 174, status: "Active", order: 1 },
  { id: "dal_7", projectId: "da_ai_hub", title: "Video giới thiệu", type: "Video", url: "https://example.com/ai-hub/video", ctaText: "Xem video", description: "Video giới thiệu nhanh về tính năng AI Hub.", isAffiliate: false, clickCount: 203, status: "Active", order: 2 },

  { id: "dal_8", projectId: "da_blockchain_exchange", title: "Sàn giao dịch", type: "Exchange", url: "https://example.com/exchange", ctaText: "Truy cập dự án", description: "Trang sàn giao dịch tài sản số mẫu.", isAffiliate: false, clickCount: 450, status: "Active", order: 1 },
  { id: "dal_9", projectId: "da_blockchain_exchange", title: "Link đăng ký Affiliate", type: "Affiliate", url: "https://example.com/exchange/ref", ctaText: "Tìm hiểu thêm", description: "Link giới thiệu cá nhân tới sàn giao dịch.", isAffiliate: true, trackingCode: "ref_exchange_01", clickCount: 1280, status: "Active", order: 2 },
  { id: "dal_10", projectId: "da_blockchain_exchange", title: "Tài liệu hướng dẫn", type: "Document", url: "https://example.com/exchange/docs", ctaText: "Xem tài liệu", description: "Tài liệu hướng dẫn sử dụng sàn giao dịch.", isAffiliate: false, clickCount: 87, status: "Active", order: 3 },
  { id: "dal_11", projectId: "da_blockchain_exchange", title: "Cộng đồng Telegram", type: "Telegram", url: "https://t.me/exchange_example", ctaText: "Tham gia cộng đồng", description: "Cộng đồng trao đổi về sàn giao dịch.", isAffiliate: false, clickCount: 312, status: "Active", order: 4 },

  { id: "dal_12", projectId: "da_web3_wallet", title: "Website chính", type: "Website", url: "https://example.com/web3-wallet", ctaText: "Truy cập dự án", description: "Trang giới thiệu ví Web3 mẫu.", isAffiliate: false, clickCount: 102, status: "Active", order: 1 },
  { id: "dal_13", projectId: "da_web3_wallet", title: "Hướng dẫn cài đặt", type: "Guide", url: "https://example.com/web3-wallet/guide", ctaText: "Xem hướng dẫn", description: "Hướng dẫn cài đặt và bảo mật ví Web3.", isAffiliate: false, clickCount: 145, status: "Active", order: 2 },

  { id: "dal_14", projectId: "da_crypto_tracker", title: "App theo dõi giá", type: "App", url: "https://example.com/crypto-tracker", ctaText: "Truy cập dự án", description: "Ứng dụng theo dõi giá và vốn hoá crypto.", isAffiliate: false, clickCount: 530, status: "Active", order: 1 },
  { id: "dal_15", projectId: "da_crypto_tracker", title: "Link Affiliate", type: "Affiliate", url: "https://example.com/crypto-tracker/ref", ctaText: "Tìm hiểu thêm", description: "Link giới thiệu cá nhân tới app theo dõi giá.", isAffiliate: true, trackingCode: "ref_tracker_01", clickCount: 967, status: "Active", order: 2 },

  { id: "dal_16", projectId: "da_crypto_analytics", title: "Website chính", type: "Website", url: "https://example.com/crypto-analytics", ctaText: "Truy cập dự án", description: "Nền tảng phân tích on-chain và dữ liệu dự án.", isAffiliate: false, clickCount: 118, status: "Active", order: 1 },
  { id: "dal_17", projectId: "da_crypto_analytics", title: "Tài liệu hướng dẫn", type: "Document", url: "https://example.com/crypto-analytics/docs", ctaText: "Xem tài liệu", description: "Tài liệu hướng dẫn sử dụng công cụ phân tích.", isAffiliate: false, clickCount: 74, status: "Active", order: 2 },

  { id: "dal_18", projectId: "da_trading_platform", title: "Nền tảng giao dịch", type: "Website", url: "https://example.com/trading-platform", ctaText: "Truy cập dự án", description: "Nền tảng giao dịch hỗ trợ biểu đồ và quản lý vị thế.", isAffiliate: false, clickCount: 289, status: "Active", order: 1 },
  { id: "dal_19", projectId: "da_trading_platform", title: "Link đăng ký Affiliate", type: "Affiliate", url: "https://example.com/trading-platform/ref", ctaText: "Tìm hiểu thêm", description: "Link giới thiệu cá nhân tới nền tảng trading.", isAffiliate: true, trackingCode: "ref_trading_01", clickCount: 1450, status: "Active", order: 2 },
  { id: "dal_20", projectId: "da_trading_platform", title: "Video hướng dẫn", type: "Video", url: "https://example.com/trading-platform/video", ctaText: "Xem video", description: "Video hướng dẫn sử dụng nền tảng trading.", isAffiliate: false, clickCount: 256, status: "Active", order: 3 },

  { id: "dal_21", projectId: "da_risk_management_tool", title: "Công cụ quản trị vốn", type: "App", url: "https://example.com/risk-tool", ctaText: "Truy cập dự án", description: "Công cụ tính toán quản trị vốn và rủi ro.", isAffiliate: false, clickCount: 163, status: "Active", order: 1 },
  { id: "dal_22", projectId: "da_risk_management_tool", title: "Hướng dẫn sử dụng", type: "Guide", url: "https://example.com/risk-tool/guide", ctaText: "Xem hướng dẫn", description: "Hướng dẫn dùng công cụ quản trị vốn hiệu quả.", isAffiliate: false, clickCount: 91, status: "Active", order: 2 },

  { id: "dal_23", projectId: "da_equity_project", title: "Trang dự án", type: "Website", url: "https://example.com/equity-project", ctaText: "Truy cập dự án", description: "Trang thông tin về doanh nghiệp và cơ hội cổ phần.", isAffiliate: false, clickCount: 205, status: "Active", order: 1 },
  { id: "dal_24", projectId: "da_equity_project", title: "Tài liệu giới thiệu", type: "Document", url: "https://example.com/equity-project/docs", ctaText: "Xem tài liệu", description: "Tài liệu giới thiệu chi tiết về doanh nghiệp.", isAffiliate: false, clickCount: 132, status: "Active", order: 2 },

  { id: "dal_25", projectId: "da_equity_funding_platform", title: "Nền tảng gọi vốn", type: "Website", url: "https://example.com/equity-funding", ctaText: "Truy cập dự án", description: "Nền tảng kết nối nhà đầu tư với doanh nghiệp gọi vốn.", isAffiliate: false, clickCount: 158, status: "Active", order: 1 },
  { id: "dal_26", projectId: "da_equity_funding_platform", title: "Link Affiliate", type: "Affiliate", url: "https://example.com/equity-funding/ref", ctaText: "Tìm hiểu thêm", description: "Link giới thiệu cá nhân tới nền tảng gọi vốn.", isAffiliate: true, trackingCode: "ref_equity_01", clickCount: 689, status: "Active", order: 2 },
];
