...
export const studentSuccessSeed: StudentStory[] = [
  ...
  },
  {
    ...
    shortDescription: "Affiliate Marketer mới bắt đầu, đi theo lộ trình Dự án & Cơ hội.",
    content:
      "Quốc Huy không biết bắt đầu từ đâu với Affiliate Marketing. Sau khi đi theo lộ trình trong Dự án & Cơ hội — chọn ngách, chọn sản phẩm, xây nội dung — anh có đơn hàng đầu tiên chỉ sau 2 tuần.",
