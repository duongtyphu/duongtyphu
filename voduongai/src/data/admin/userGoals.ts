...
export const userGoalsSeed: UserGoal[] = [
  ...
  },
  {
    ...
    goalKey: "affiliate",
    label: "Làm Affiliate",
    description: "Vào Dự án & Cơ hội để chọn ngách và sản phẩm phù hợp.",
    icon: "🤝",
    suggestionText: "Vào Dự án & Cơ hội để chọn ngách và sản phẩm phù hợp.",
    suggestedRoute: "/portal/duan-cohoi",
    order: 2,
    status: "Published",
  },
  {
