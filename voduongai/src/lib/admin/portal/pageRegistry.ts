...
export const PORTAL_PAGES_SEED: PortalPageEntry[] = [
  ...
  { id: "page_hanhtrinh", areaId: "hanhtrinh", parentPageId: "", title: "Hành trình của tôi", route: "/portal/hanhtrinhcuatoi", visible: true, sortOrder: 1, publishStatus: "Active", seoContextNote: "Không áp dụng — trang sau đăng nhập.", workspaceOwner: "Journey", updatedDate: "2026-07-12" },
  { id: "page_su_menh_companion", areaId: "su-menh-companion", parentPageId: "", title: "Sứ mệnh Companion", route: "/portal/su-menh-companion", visible: true, sortOrder: 1, publishStatus: "Active", seoContextNote: "Không áp dụng — trang sau đăng nhập.", workspaceOwner: "Companion Studio", updatedDate: "2026-07-12" },
  { id: "page_congdongai", areaId: "congdongai", parentPageId: "", title: "Cộng đồng", route: "/portal/congdongai", visible: true, sortOrder: 1, publishStatus: "Active", seoContextNote: "Không áp dụng — trang sau đăng nhập.", workspaceOwner: "Community", updatedDate: "2026-07-12" },
  ...
  { id: "page_hanhtrinh_bando", areaId: "hanhtrinh", parentPageId: "page_hanhtrinh", title: "Bản đồ hành trình", route: "/portal/hanhtrinhcuatoi/ban-do", visible: true, sortOrder: 1, publishStatus: "Active", seoContextNote: "Không áp dụng.", workspaceOwner: "Journey", updatedDate: "2026-07-12" },
  { id: "page_hanhtrinh_khuvuon", areaId: "hanhtrinh", parentPageId: "page_hanhtrinh", title: "Khu vườn của bạn (Living Garden)", route: "/portal/khuvuoncuaban", visible: true, sortOrder: 2, publishStatus: "Active", seoContextNote: "Không áp dụng.", workspaceOwner: "Journey", updatedDate: "2026-07-12" },
  { id: "page_hanhtrinh_mirror", areaId: "hanhtrinh", parentPageId: "page_hanhtrinh", title: "Mirror", route: "/portal/mirror", visible: true, sortOrder: 3, publishStatus: "Active", seoContextNote: "Không áp dụng.", workspaceOwner: "Journey", updatedDate: "2026-07-12" },
  { id: "page_hanhtrinh_nhatky", areaId: "hanhtrinh", parentPageId: "page_hanhtrinh", title: "Nhật ký học tập", route: "/portal/nhatkyhoctap", visible: true, sortOrder: 4, publishStatus: "Active", seoContextNote: "Không áp dụng.", workspaceOwner: "Journey", updatedDate: "2026-07-12" },
  { id: "page_hanhtrinh_story", areaId: "hanhtrinh", parentPageId: "page_hanhtrinh", title: "Câu chuyện của tôi", route: "/portal/story", visible: true, sortOrder: 5, publishStatus: "Active", seoContextNote: "Không áp dụng. Lưu ý: KHÔNG liên quan Founder Story (đính chính MEDIA-SPR-202) — đây là nhật ký tăng trưởng cá nhân hoá của học viên.", workspaceOwner: "Journey", updatedDate: "2026-07-12" },
