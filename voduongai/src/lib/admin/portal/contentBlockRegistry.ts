...
export const PORTAL_CONTENT_BLOCKS_SEED: PortalContentBlock[] = [
  ...
  { id: "content_duancohoi_gem_cards", sectionId: "sec_duancohoi_gem_cards", title: "Danh sách Ecosystem đầu tư", contentTypeNote: "⚠️ ECOSYSTEMS (src/app/portal/duan-cohoi/page.tsx, hardcode nội bộ, KHÔNG phải Ecosystem canonical trong ecosystems.ts) — 5 mục, chưa có CRUD (PROJECTS-SPR-601).", workspaceOwner: "Projects & Opportunities", visible: true, sortOrder: 1, status: "Active", updatedDate: "2026-07-13" },
