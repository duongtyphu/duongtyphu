...
export const MEDIA_ASSETS_SEED: MediaAsset[] = [
  ...
  },
  {
    ...
    tags: ["founder"],
    usedByNote:
      "⚠️ src/data/portal/founder.ts (trang Portal /portal/story) — ảnh founder KHÁC với media_seed_founder_home (2 file khác nhau cho cùng chủ đề founder). Chưa rõ có chủ đích, cần Founder xác nhận.",
    workspaceOwnerNote: "Portal (trang Story)",
    status: "Active",
    sortOrder: 2,
    createdDate: "2026-07-12",
    updatedDate: "2026-07-12",
  ...
  },
  {
    ...
    collectionId: "",
    tags: ["garden"],
    usedByNote: "Dùng ở 3 nơi: GardenWidget.tsx, scene/TreeLayer.tsx, LivingGardenCard.tsx — asset tái sử dụng thật, ví dụ rõ nhất cho field Used By.",
    workspaceOwnerNote: "Portal (Living Garden feature)",
    status: "Active",
    sortOrder: 4,
    createdDate: "2026-07-12",
    updatedDate: "2026-07-12",
  },
  {
    ...
    collectionId: "",
    tags: ["garden", "unused"],
    usedByNote: "⚠️ Không tìm thấy tham chiếu nào trong code (grep toàn repo) — asset mồ côi, tồn tại trong public/ nhưng chưa/không còn được dùng.",
    workspaceOwnerNote: "Chưa rõ — cần Founder xác nhận còn cần giữ hay dọn dẹp.",
    status: "Draft",
    sortOrder: 5,
    createdDate: "2026-07-12",
    updatedDate: "2026-07-12",
