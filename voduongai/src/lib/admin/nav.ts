    ...
    subGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          // Giai đoạn 5 — quyền lợi/cố vấn chọn gói/người đồng hành riêng
          // của /v2/premium (không dùng chung route "Dashboard (Live-edit)"
          // ở trên — đó là /portal/premium 1.0, 2 trang độc lập).
          { label: "Premium 2.0 (Live-edit)", href: "/admin/premium/v2-dashboard" },
