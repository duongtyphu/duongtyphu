...
const EVENT_LABEL: Record<GrowthEventType, string> = {
  ...
  WORKSPACE_RESUMED: "Tiếp tục Không gian làm việc đang làm dở",
  WORKSPACE_COMPLETED: "Hoàn thành Không gian làm việc",
  MISSION_STARTED: "Bắt đầu Nhiệm vụ",
  MISSION_COMPLETED: "Hoàn thành Nhiệm vụ",
  OUTPUT_CREATED: "Tạo Kết quả mới",
  OUTPUT_UPDATED: "Cập nhật Kết quả",
  OUTPUT_VERSIONED: "Lưu phiên bản mới của Kết quả",
  REVIEW_STARTED: "Bắt đầu Đánh giá",
  REVIEW_COMPLETED: "Hoàn thành Đánh giá",
  REFLECTION_STARTED: "Bắt đầu Chiêm nghiệm",
  REFLECTION_COMPLETED: "Hoàn thành Chiêm nghiệm",
  PORTFOLIO_CREATED: "Thêm một Thành quả mới",
  CAPABILITY_UPDATED: "Năng lực được cập nhật",
  IMPACT_UPDATED: "Ghi nhận AI Impact",
  MISSION_UNLOCKED: "Mở khóa Nhiệm vụ mới",
  AGENT_RUN_STARTED: "AI Agent bắt đầu xử lý",
  AGENT_RUN_COMPLETED: "AI Agent hoàn thành xử lý",
  AGENT_RUN_FAILED: "AI Agent gặp lỗi",
  OUTPUT_REVIEWED: "Reviewer Agent đã đánh giá Kết quả",
  USER_APPROVAL_REQUIRED: "Đang chờ bạn phê duyệt",
  COMPANION_ACTIVATED: "AI Companion được kích hoạt vào Đội ngũ AI",
  COMPANION_TASK_ASSIGNED: "Companion nhận Công việc mới",
  COMPANION_TASK_COMPLETED: "Companion hoàn thành Công việc",
  OUTPUT_APPROVED: "Chủ sở hữu đã phê duyệt Kết quả",
  MEMORY_UPDATED: "Bộ nhớ được cập nhật",
};
