...
export const portalHubs: PortalHub[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { label: "Quy trình", description: "Quy trình làm việc AI từng bước, dễ tái sử dụng." },
  ...
  },
  {
    ...
    modules: [
      ...
      { label: "Đóng góp nổi bật", description: "Những câu chuyện đóng góp được cộng đồng đón nhận." },
  ...
  },
  {
    ...
    modules: [
      { label: "My Story", description: "Học viện kể lại hành trình trưởng thành của riêng bạn.", href: "/portal/story" },
      ...
      { label: "Quy trình của tôi", description: "Quy trình làm việc bạn tự xây." },
